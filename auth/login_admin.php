...
<div class="auth-wrap">
    <div class="auth-card">
        ...
        <form method="POST">
            ...
            <span style="display:inline-block; background:#fff; border:1px solid #fcd34d; border-radius:4px; padding:2px 8px; margin-bottom:2px; font-family:monospace;">Nom d\'utilisateur : admin</span><br>
            <span style="display:inline-block; background:#fff; border:1px solid #fcd34d; border-radius:4px; padding:2px 8px; font-family:monospace;">Mot de passe : admin123</span>
        </div>
