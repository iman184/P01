...
<div class="auth-wrap">
    <div class="auth-card">
        ...
        <form method="POST">
            ...
            <span style="display:inline-block; background:#fff; border:1px solid #fcd34d; border-radius:4px; padding:2px 8px; margin-bottom:2px; font-family:monospace;">Email : zighedimen921@gmail.com</span><br>
            <span style="display:inline-block; background:#fff; border:1px solid #fcd34d; border-radius:4px; padding:2px 8px; margin-bottom:2px; font-family:monospace;">N° Étudiant : 232335330411</span><br>
            <span style="display:inline-block; background:#fff; border:1px solid #fcd34d; border-radius:4px; padding:2px 8px; font-family:monospace;">Mot de passe : 232335330411</span>
        </div>
